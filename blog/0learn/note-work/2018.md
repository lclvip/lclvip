...
1. 恢复损坏的数据页文件：
  检查Sql版本和恢复模式：简单和完整模式
参考脚本：http://sliceof-it.blogspot.com/2010/12/database-id-5-page-14171728-is-marked.html
官方说明文档：[还原页](https://docs.microsoft.com/zh-cn/sql/relational-databases/backup-restore/restore-pages-sql-server?view=sql-server-2014)  [还原与恢复概述 (SQL Server)](https://docs.microsoft.com/zh-cn/sql/relational-databases/backup-restore/restore-and-recovery-overview-sql-server?view=sql-server-2017)  [Performing Page Restores sql2005](https://docs.microsoft.com/en-us/previous-versions/sql/sql-server-2005/ms175168(v=sql.90))
其他资料：[SqlServer 数据页损坏还原测试](https://blog.csdn.net/kk185800961/article/details/50663780) [SQL Server 2005 Page Restore](https://amihalj.wordpress.com/2012/01/10/sql-server-page-restore/)
